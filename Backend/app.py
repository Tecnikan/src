...
catalogo = Catalogo(host=bd.host, user=bd.user,
                    password=bd.password, database=bd.database)
...
def agregar_producto():
    ...
    nuevo_codigo = catalogo.agregar_producto(
        descripcion, cantidad, precio, nombre_imagen, proveedor)
    if nuevo_codigo:
